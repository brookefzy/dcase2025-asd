...
def get_argparse():
    ...
    parser.add_argument('--time_stretch_range', type=float, nargs=2, default=[0.9, 1.1])
    parser.add_argument('--time_stretch_p', type=float, default=0.5)
    parser.add_argument('--pitch_shift_range', type=int, nargs=2, default=[-2, 2])
    parser.add_argument('--pitch_shift_p', type=float, default=0.5)
