...
DOWNLOAD_PATH_YAML_DICT = {
    ...
    "DCASE2023T2":f"{DATA_ROOT}/datasets/download_path_2023.yaml",
    "legacy":f"{DATA_ROOT}/datasets/download_path_legacy.yaml",
}        
########################################################################
...
########################################################################
YAML_PATH = {
    "legacy":f"{DATA_ROOT}/datasets/machine_type_legacy.yaml",
    "DCASE2023T2_dev":f"{DATA_ROOT}/datasets/machine_type_2023_dev.yaml",
    "DCASE2023T2_eval":f"{DATA_ROOT}/datasets/machine_type_2023_eval.yaml",
    "DCASE2024T2_dev":f"{DATA_ROOT}/datasets/machine_type_2024_dev.yaml",
    "DCASE2024T2_eval":f"{DATA_ROOT}/datasets/machine_type_2024_eval.yaml",
    "DCASE2025T2_dev":f"{DATA_ROOT}/datasets/machine_type_2025_dev.yaml",
    "DCASE2025T2_eval":f"{DATA_ROOT}/datasets/machine_type_2025_eval.yaml",
}
